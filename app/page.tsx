            ...
            <div className="lg:col-span-3 space-y-6 sm:space-y-8">
              <div className="space-y-3 sm:space-y-2">
                ...
                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-light tracking-tight">
                  Boubacar
                  <br />
                  <span className="text-muted-foreground">Ballo</span>
                </h1>
              </div>

              <div className="space-y-6 max-w-md">
                <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
                  NYU Student and Software Engineer, building 
                  <span className="text-foreground"> ML Systems</span>,<span className="text-foreground"> Agents</span>,
                  and
            ...
            <div className="lg:col-span-2 flex flex-col justify-end space-y-6 sm:space-y-8 mt-8 lg:mt-0">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="text-foreground">Agentic Knowledge Retrieval Research</div>
                  <div className="text-muted-foreground">@ NYU</div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {["TypeScript", "React", "Python", "LLMs", "RAG", "GCP"].map((skill) => (
                    <span
                      key={skill}
              ...
              {[
                {
                  ...
                  role: "LLM Researcher",
                  company: "NYU",
                  description: "Investigating agentic knowledge retrieval in robot swarms.",
                  tech: ["Python", "Violet", "LLMs"],
                },
                {
                  year: "2025",
                  role: "Software Engineer Intern",
                  company: "Vault",
                  description: "Automated portfolio return mechanisms and activity log systems.",
                  tech: ["React", "GraphQL", "TypeScript", "Redis", "MySQL"],
                },
                {
                  year: "2025",
                  role: "Software Engineer Intern",
                  company: "AlFahad Trading Enterprises",
                  description: "Build a scalable messaging system for the company.",
                  tech: ["React", "PostgreSQL", "AWS", "IndexedDB"],
                },
                {
                  year: "2024",
                  role: "LLM Researcher",
                  company: "NYU Courant Institute of Mathematical Sciences",
                  description: "Mitigating medical LLM biases with fine-tuning.",
                  tech: ["Python", "UnSloth", "Fine-tuning", "LLMs"],
                },
              ].map((job, index) => (
                <div
                  key={index}
                    ...
                    <div>
                      <div className="flex items-center gap-3">
                        ...
                        <Link
                          ...
                          className="group/github p-1.5 rounded-md border border-border hover:border-muted-foreground/50 transition-all duration-300 hover:shadow-sm"
                          aria-label={`View ${project.title} on GitHub`}
                        >
                          <svg
                            className="w-4 h-4 text-muted-foreground group-hover/github:text-foreground transition-colors duration-300"
                            fill="currentColor"
                            viewBox="0 0 24 24"
                          >
